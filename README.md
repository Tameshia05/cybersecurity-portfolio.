...
**Career Plans:**  
After completing my cybersecurity course, I plan to pursue roles such as Security Analyst or SOC Analyst. My long-term goal is to specialize in threat intelligence or digital forensics, helping to investigate and stop cybercrime.

**Proud Project/Task:**  
One of the projects I’m most proud of is a beginner-level security audit I performed on my home network. I identified vulnerabilities in my Wi-Fi settings and successfully secured the network using WPA3 encryption and better firewall settings. This gave me the confidence that I can apply what I learn to real-world problems.
